                        ...
                        <div class="header-area">
                            ...
                            <nav role="navigation" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement">
                                <ul id="menu-main-nav" class="sf-menu">
                                    <li id="menu-item-4699" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-4469 current_page_item"><a href="index.php"><span><strong>Home</strong></span></a></li>
                                    <li id="menu-item-6580" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="Blog.php"><span><strong>Blog</strong></span></a></li>
